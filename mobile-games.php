...
if (isset($_GET['page']) && $_GET['page'] == 1) {
  header("Location: /mobile-games", true, 301);
  exit;
}
?>
...
<?php
require __DIR__ . "/includes/mobile-games-articles.php";
...
/* SEO */
$pageTitle = $page > 1 
  ? "Mobile Games – Page $page | LoveGamingHub"
  : "Mobile Games | LoveGamingHub";

$pageDescription = "Complete Mobile Games guide.";
if ($page > 1) {
...
?>
    ...
    <?php
        ...
        $canonical = "https://lovegaminghub.com/mobile-games";
    ...
    <main>
        <div style="background-color: #edf2f7;border:1px solid #dcdcdc;">
            <div style="max-width:1000px;margin:auto;padding:0 5px">
                ...
                <a href="https://lovegaminghub.com/mobile-games" style="color: #4a5568;font-weight: 500;font-size:.75rem;text-decoration:none">Mobile games</a>
            </div>
        </div>
        <div class="container">
